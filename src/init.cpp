...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-maxreorg=<n>", strprintf("Set the maximum reorg depth (default: %u)", defaultChainParams->MaxReorganizationDepth()), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
