...
//! -discardfee default
static const CAmount DEFAULT_DISCARD_FEE = 250000000; // 10x -mintxfee default (as per SIN modification)
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 25000000; //SIN modified
/**
